...
2. Product direction has been approved via [GATE-001](approval-gates/GATE-001-options-and-direction-approval.md); treat the recommended direction as an approved input to solution design.
3. Solution design may now begin because [GATE-002](approval-gates/GATE-002-product-brief-approval.md) is approved; architecture, material UX/product-flow, external-service, credential, destructive-action, deployment, merge, and final-acceptance decisions remain gated.
4. Implementation, backlog execution, and prototype construction may now proceed because GATE-002 and [GATE-003](approval-gates/GATE-003-prototype-scope-approval.md) are approved; later approval gates still apply to architecture, UX, external services, credentials, deployment, destructive actions, PR merges, and final acceptance.
