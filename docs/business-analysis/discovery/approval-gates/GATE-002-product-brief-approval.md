...
| Related objects | [Product Brief](../product-brief.md) |
| Update rule | Update when this object or its supporting evidence changes materially |

## Approval Condition

Approve, revise, or reject the product brief after confirming the problem, target users, needs, evidence, hypotheses, success criteria, constraints, and recommended direction.
