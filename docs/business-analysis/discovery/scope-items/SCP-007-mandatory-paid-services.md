# SCP-007: Mandatory paid services
...
Paid external services required for core ForgePilot operation.

## Boundary

Classification: **Out of scope**. Changes to this classification require prototype-scope review and approval.
