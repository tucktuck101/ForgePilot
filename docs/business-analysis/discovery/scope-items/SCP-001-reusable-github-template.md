# SCP-001: Reusable GitHub template
...
A reusable repository template containing the required operating structure and documentation.

## Boundary

Classification: **In scope**. Changes to this classification require prototype-scope review and approval.
