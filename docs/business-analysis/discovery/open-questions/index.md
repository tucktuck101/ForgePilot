...
|---|---|---|---|---|---|
| OQ-001 | What is the current prototype-cycle baseline? | Measurement | Must | Open | [OQ-001-prototype-cycle-baseline.md](OQ-001-prototype-cycle-baseline.md) |
| OQ-002 | What is the minimum validated stack set? | Product scope | Should | Open | [OQ-002-minimum-supported-stack-set.md](OQ-002-minimum-supported-stack-set.md) |
| OQ-003 | How will runtime approvals be recorded? | Governance | Must | Open | [OQ-003-runtime-approval-recording.md](OQ-003-runtime-approval-recording.md) |
