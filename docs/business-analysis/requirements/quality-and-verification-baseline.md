...
| Evidence | [EVD-001](../discovery/evidence/EVD-001-stakeholder-request-2026-06-24.md), [EVD-002](../discovery/evidence/EVD-002-existing-business-analysis-corpus.md), [EVD-003](../discovery/evidence/EVD-003-repository-gap-observation.md) |
...
| NFR-006 Token efficiency | A fresh-session navigation test completes the assigned task from compact indexes and directly linked objects without loading the full BA corpus. |
...
| NFR-013 Documentation quality | Formal artefacts pass agreed heading, metadata, status, link, and readability checks; placeholder content is excluded from live truth. |
| NFR-014 Doc-object consistency | Every indexed live object contains its required metadata and collection-specific content; duplicate IDs and unindexed live objects fail validation. |
